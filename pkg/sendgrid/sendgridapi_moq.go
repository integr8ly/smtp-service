...
//             },
//             DeleteAPIKeyFunc: func(id string, keyName string) error {
...
func (mock *APIClientMock) DeleteAPIKey(id string, keyName string) error {
	...
	return mock.DeleteAPIKeyFunc(id, keyName)
}
